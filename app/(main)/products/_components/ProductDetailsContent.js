...
const ProductDetailsContent = ({ slug }) => {
  ...
  const {
    ...
    error: productError,
  } = useFetchData(getProduct, [language, slug, token, isRetailer]);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
              ...
              <div className="product-details-content">
                <div>
                  ...
                  <p className="mb-5 font-semibold text-gray-800 lg:mb-10 text-2x lg:text-3xl product-price">
                    ...
                    <span
                      className={`inline-block ${
                        sale_price > 0 ? 'line-through text-xs lg:text-2xl' : ''
                      }`}
                    >
                  ...
                  {stock < 1 && (
                    <p className="mb-5 text-red-500">{outOfStock}</p>
                  )}
                </div>
                <ProductOrder
                  product={product}
                ...
                <div className="mt-5">
                  <SocialShare dictionary={dictionary.ProductDetails} />
                </div>
              </div>
            </div>
            <div
