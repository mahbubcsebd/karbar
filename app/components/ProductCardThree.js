    ...
    return (
        ...
        >
            ...
            <div className="product-content p-[10px] md:p-[18px]">
                <Link
                    href={`/products/${slug}`}
                    className="block mb-1 text-xs font-medium text-gray-900 sm:text-base lg:text-base xl:text-lg md:mb-2 product-title ellipsis-2 xl:min-h-14 hover:text-[#4C20CD] transition-all duration-150 capitalize"
                >
                    {name}
                </Link>
