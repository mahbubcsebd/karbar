            ...
            >
                ...
                >
                    <input
                        ...
                        className="w-full h-full block pl-[60px] pr-[14px] py-4 bg-white border border-[#D14BF8] text-gray-600 placeholder:text-gray-500 placeholder:text-base outline-hidden rounded-full search-shadow"
