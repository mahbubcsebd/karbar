  ...
  return (
    <div>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger asChild area-label="login button">
          {children}
        </DialogTrigger>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`block w-full px-3 py-2 border ${
                        errors.fullName ? 'border-red-500' : 'border-[#D0D5DD]'
                      } text-gray-700 ring-1 ring-inset ${
                        errors.fullName ? 'ring-red-500' : 'ring-[#D0D5DD]'
                  ...
                  <div>
                    ...
                    <PhoneInput
                      ...
                      inputClass={`block w-full px-3 py-2 border ${
                        ...
                        errors.phone ? 'ring-red-500' : 'ring-[#D0D5DD]'
                      } focus:ring-1 focus:ring-blue-900 placeholder:text-gray-600 placeholder:text-sm outline-hidden rounded-md input-shadow bg-white`}
                    />
              ...
              <div>
                ...
                >
                  ...
                  {authType === 'signIn' ? dictionary.Auth.orPhone : ''}
                </label>
                <input
                  type="text"
                  id="username"
                  ...
                  className={`block w-full px-3 py-2 border ${
                    ...
                    errors.username ? 'ring-red-500' : 'ring-[#D0D5DD]'
                  } focus:ring-1 focus:ring-blue-900 placeholder:text-gray-600 placeholder:text-sm outline-hidden rounded-md input-shadow bg-white`}
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full px-3 py-2 border ${
                      ...
                      errors.confirmPassword ? 'ring-red-500' : 'ring-[#D0D5DD]'
                    } focus:ring-1 focus:ring-blue-900 placeholder:text-gray-600 placeholder:text-sm outline-hidden rounded-md input-shadow bg-white`}
                    placeholder={dictionary.Auth.confPassPlaceholder}
                  />
                  <button
                    type="button"
