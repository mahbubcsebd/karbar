    ...
    if (completed) {
      ...
      return (
        <div className="flex items-center gap-1">
          <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-xs flex flex-col justify-center items-center rounded-[4px] bg-gray-900 text-white">
            {formatNumber(days)}{' '}
          ...
          <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-xs flex flex-col justify-center items-center rounded-[4px] bg-gray-900 text-white">
            ...
            <span className="text-[7px] sm:text-[8px] md:text-[9px]">min</span>
          </div>{' '}
          :{' '}
          <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-xs flex flex-col justify-center items-center rounded-[4px] bg-gray-900 text-white">
            {formatNumber(seconds)}{' '}
            <span className="text-[7px] sm:text-[8px] md:text-[9px]">sec</span>
          </div>
        </div>
      );
    }
